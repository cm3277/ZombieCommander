...
import com.JustMoser.ZombieCommander.Helper.Audio.LRUCache.CacheEntryRemovedListener;
...
public class SoundManager implements CacheEntryRemovedListener<SoundEffects,Sound>, Disposable
{
    ...
    public enum SoundEffects
    {
        ...
        BLOCKERTHUD( "sound/BlockerThud.wav" ),
        PURCHASE( "sound/Purchase.wav" ),
        NEWROUNDSCARY( "sound/NewRoundScary.wav" ),
        EXPLOSION( "sound/Explosion.wav" ),
        BRAIN( "sound/Brain.wav" );
