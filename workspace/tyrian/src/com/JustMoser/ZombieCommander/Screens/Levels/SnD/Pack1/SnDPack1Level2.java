...
public class SnDPack1Level2 extends SnDLevel
{
    ...
    {
    	//localHuman = Human.create(stage.getWidth()*0.8f, stage.getHeight()*0.8f);
        //stage.addActor(localHuman);
        stage.addActor(SniperHuman.create(stage.getWidth()*0.7f, stage.getHeight()*0.8f));
    }
    
    public void addSpawns()
    {
    	zombieSpawn = ZombieSpawn.create(new Vector2(stage.getWidth()*0.1f, stage.getHeight()*0.1f));
    ...
    {
    	chest = Chest.create(stage.getWidth()*0.9f, stage.getHeight()*0.9f );
        stage.addActor(chest);
        BrickWall brickWall = BrickWall.create(stage.getWidth()*0.3f, stage.getHeight()*0.3f );
