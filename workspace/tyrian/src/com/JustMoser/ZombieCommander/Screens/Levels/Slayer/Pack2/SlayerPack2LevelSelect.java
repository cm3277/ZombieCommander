...
public class SlayerPack2LevelSelect extends AbstractScreen
{
	//private static Image backgroundImage;
	private int gameTypeId;
	private int packId;
	
    public SlayerPack2LevelSelect(Tyrian game )
    {
        super( game );
        gameTypeId = LevelManager.getSlayer();
        packId = LevelManager.getPackId(gameTypeId, 2);
    }
    ...
    private Table getMenuTable()
    {
        ...
        table.clear();
        //table.setPosition(stage.getWidth()/2, 800 * 0.8f);
        Label lblWelcome = new Label("Level Selection", super.getSkin());
        lblWelcome.setWrap(true);
        lblWelcome.setAlignment(1);
        lblWelcome.setPosition(stage.getWidth()*0.1f, 800 * 0.9f);
    ...
    private Button getLevel1Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SlayerPack2Level1( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel2Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SlayerPack2Level2( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel3Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SlayerPack2Level3( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel4Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SlayerPack2Level4( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel5Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SlayerPack2Level5( game ) );
            }
    	});
    	return levelButton;
    }
