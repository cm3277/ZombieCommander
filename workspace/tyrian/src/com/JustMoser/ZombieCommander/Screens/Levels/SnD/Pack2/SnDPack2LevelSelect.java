...
public class SnDPack2LevelSelect extends AbstractScreen
{
	//private static Image backgroundImage;
	private int gameTypeId;
	private int packId;
	
    public SnDPack2LevelSelect(Tyrian game )
    {
        super( game );
    ...
    private Table getMenuTable()
    {
        ...
        Label lblWelcome = new Label("SnD2 Level Selection", super.getSkin());
    ...
    private Button getLevel1Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SnDPack2Level1( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel2Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SnDPack2Level2( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel3Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SnDPack2Level3( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel4Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SnDPack2Level4( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel5Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new SnDPack2Level5( game ) );
            }
    	});
    	return levelButton;
    }
