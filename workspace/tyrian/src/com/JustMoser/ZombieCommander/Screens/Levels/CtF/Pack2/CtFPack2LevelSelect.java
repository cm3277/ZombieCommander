...
public class CtFPack2LevelSelect extends AbstractScreen
{
	//private static Image backgroundImage;
	private int gameTypeId;
	private int packId;
	
    public CtFPack2LevelSelect(Tyrian game )
    {
        super( game );
    ...
    private Button getLevel1Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new CtFPack2Level1( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel2Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new CtFPack2Level2( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel3Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new CtFPack2Level3( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel4Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new CtFPack2Level4( game ) );
            }
    	});
    	return levelButton;
    }
    ...
    private Button getLevel5Button()
    {
    	...
    	levelButton.addListener(new ClickListener() {
            ...
            {
                super.touchUp( event, x, y, pointer, button );
                game.setScreen( new CtFPack2Level5( game ) );
            }
    	});
    	return levelButton;
    }
